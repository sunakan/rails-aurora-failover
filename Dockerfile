...
# docker build -t rails_aurora_failover .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name rails_aurora_failover rails_aurora_failover
